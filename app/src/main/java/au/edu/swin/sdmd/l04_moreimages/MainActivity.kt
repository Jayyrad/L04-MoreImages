        ...
        savedInstanceState?.let {
            ...
            image.apply {
                when (contentDescription) {
                    "station" -> setImageDrawable(getDrawable(R.drawable.station))
                    "college" -> setImageDrawable(getDrawable(R.drawable.college))
                    "theatre" -> setImageDrawable(getDrawable(R.drawable.theatre))
                }
            }
